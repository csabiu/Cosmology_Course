...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\columnwidth]{figures/desi.png}
...
\begin{figure}[H]
\centering
% TODO: Add figure --- BAO dark energy constraints
\fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}\textit{Figure placeholder: BAO constraints on dark energy from SDSS/BOSS/eBOSS}\vspace{2cm}}}
